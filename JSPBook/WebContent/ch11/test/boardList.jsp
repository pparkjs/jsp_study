...
<!-- 
 ...
 <%
 	...
 	List<BoardVO> list = board.selectBoardList();
 %>
	...
	<table border="1"  style="text-align: center; border-collapse:collapse;"> 
		...
		<c:choose>
			...
			<c:otherwise>
				...
				<tr>
					<td><a href="boardView.jsp?no=${list.getNo()}" style="text-decoration: none; color: black;">${list.getTitle()}</a></td>
...
<br>
<a href="boardForm.jsp">게시글 등록하기</a>
